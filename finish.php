...
$consulta = "SELECT sessionId , status from orders_web where sessionId='$token' and status=0";
...
<center><h1 style="  font-family:  'Montserrat', sans-serif;font-size: 25px;">Transacción Aprobada</h1></center>
...
<center>
    ...
    <div class="col s12 m12" >
      ...
      <table class="highlight">
        ...
        <tbody style="color: yellow;font-family:  'Montserrat', sans-serif;">
          ...
          <tr>
             <td>Monto : </td>
            <td>$<?php echo $_SESSION['monto_pagado']; ?></td>
          </tr>
          <tr>
             <td>Orden de Compra : </td>
            <td><?php echo $_SESSION['orden_compra']; ?></td>
          </tr>
           <tr>
             <td>N° de cuotas :  </td>
            <td><?php echo $_SESSION['numero_cuotas']; ?></td>
          </tr>
             <tr>
             <td>Últimos 4 Digitos de la Tarjeta :</td>
            <td><?php echo $_SESSION['4_digitos'];?></td>
          </tr>
            <tr>
             <td>Código Autorizacion : </td>
            <td><?php echo $_SESSION['codigo_autorizacion'];?></td>
          </tr>
          <tr>
	...
	<?php }
/* Comprobante Transaccion rechazada */	
else 
{ 
	// echo "Rechazada"; ?>
	<!DOCTYPE html>
  ...
  <link href="https://fonts.googleapis.com/css?family=Montserrat&display=swap" rel="stylesheet">
	...
	<body>
<?php include 'sidenav.php'; ?>
<center><h1 style="  font-family:  'Montserrat', sans-serif;font-size: 25px;">Transacción Rechazada</h1></center>
 ...
 <center><img src="img/icon_error.png" alt="" height="42" width="42">  </center>
        ...
        <tbody style="color: yellow;font-family:  'Montserrat', sans-serif;">
          ...
          <tr>
             <td>Monto : </td>
            <td>$<?php echo $_SESSION['monto_a_pagar']; ?></td>
          </tr>
          <tr>
             <td>Orden de Compra : </td>
            <td><?php echo $_SESSION['orden_compra']; ?></td>
